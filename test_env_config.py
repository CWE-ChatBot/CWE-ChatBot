...
def test_environment_info():
    ...
    print(f"  POSTGRES_PASSWORD set: {env_info['important_vars_set']['POSTGRES_PASSWORD']}")
    print(f"  OPENAI_API_KEY set: {env_info['important_vars_set']['OPENAI_API_KEY']}")
    
    # Should detect your environment
    assert env_info.get('loaded_from') is not None, "Should detect loaded environment file"
    assert env_info['important_vars_set']['OPENAI_API_KEY'], "Should detect OPENAI_API_KEY"
