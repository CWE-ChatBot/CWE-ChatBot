...
def format_chat_file(input_file, output_file):
    ...
    while i < len(lines):
        ...
        if (line == "B" and 
            i + 1 < len(lines) and lines[i + 1].strip() == "BMAD full stack" and
            i + 2 < len(lines) and lines[i + 2].strip() == "Custom Gem" and
            i + 3 < len(lines) and lines[i + 3].strip() == "Show thinking"):
