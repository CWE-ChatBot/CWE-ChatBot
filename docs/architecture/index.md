...
- [CWE ChatBot Fullstack Architecture Document](#table-of-contents)
  ...
  - [Data Models](./data-models.md)
    ...
    - [CWE_Embedding (Conceptual model for pgvector in PostgreSQL)](./data-models.md#cwe_embedding-conceptual-model-for-pgvector-in-postgresql)
  ...
  - [Database Schema](./database-schema.md)
    ...
    - [Vector Index Conceptual Schema (pgvector in PostgreSQL)](./database-schema.md#vector-index-conceptual-schema-pgvector-in-postgresql)
  - [REST API Spec](./rest-api-spec.md)
    - [OpenAPI 3.0 Specification (YAML)](./rest-api-spec.md#openapi-30-specification-yaml)
