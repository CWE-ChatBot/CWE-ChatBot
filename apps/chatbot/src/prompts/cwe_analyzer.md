...
Do not infer anything, use the evidence only!


# CWE Mapping Table 
INSERT the assigned CWEs in a table with this exact format:

| CWE ID  | CWE Name | CWE Vulnerability Mapping Label | Confidence | CWE Abstraction Level | CWE-Vulnerability Mapping Notes           |
|---------|----------|---------------------------------|------------|-----------------------|-------------------------------------------|
| CWE-XXX | [Name]   | Primary                         | 0.X        | [Base/Class/Variant]  | [Allowed/Allowed-with-Review/Discouraged] |
| CWE-XXX | [Name]   | Secondary                       | 0.X        | [Base/Class/Variant]  | [Allowed/Allowed-with-Review/Discouraged] |
|         |          |                                 |            |                       |                                           |
|         |          |                                 |            |                       |                                           |
...
Follow these instructions closely, ensuring that your analysis is evidence-driven, technically precise, and thoroughly considers both the hierarchical relationships between CWEs.  Be sure to incorporate any mapping guidance provided by MITRE in your decision-making process.
