...
def make_chunk(cwe_id: str, section: str, text: str, hybrid: float = 0.8):
    return {
        "metadata": {"cwe_id": cwe_id, "section": section, "section_rank": 1, "name": ""},
        "document": text,
...
def test_alias_exact_match_boosts_missing_authentication():
    ...
    query = "This vulnerability is due to missing authentication in a critical function."
    ...
    cwe_chunks = {
        "CWE-306": {
            ...
            "chunks": [
                ...
                make_chunk("CWE-306", "Description", "Authentication controls are missing for critical functionality."),
            ],
            "exact_match": False,
        },
        "CWE-862": {
            ...
            "chunks": [
                make_chunk("CWE-862", "Aliases", "missing authorization; privilege not checked", hybrid=0.82),
                make_chunk("CWE-862", "Description", "Authorization check is missing for a resource."),
            ],
            "exact_match": False,
        },
    }
