...
class ChainlitTestHelper:
    ...
    async def wait_for_chainlit_ready(self, timeout: int = 30000) -> None:
        ...
        await self.page.wait_for_selector('[data-testid="chainlit-app"], .chainlit-app, #root', timeout=timeout)
    ...
    async def submit_message(self, message: str, wait_for_response: bool = True) -> None:
...
async def setup_test_environment(page: Page, base_url: str = "http://localhost:8000") -> ChainlitTestHelper:
